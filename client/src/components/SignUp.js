...
import {signUpUser,oauthFacebook,oauthGoogle} from '../actions/authActions'
...
export default connect(mapStateToProps,{signUpUser,oauthFacebook,oauthGoogle})(withRouter(SignUp))